...
Versuche das in deinem `blog/templates/blog/post_list.html` Template. Öffne es im Code-Editor und ersetze die vorhandenen `<article>`-Elemente durch `{{ posts }}`. Speichere die Datei und aktualisiere die Seite, um die Ergebnisse anzuzeigen.
